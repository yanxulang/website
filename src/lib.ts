...
export const yanjuRepository = "https://github.com/YanXuLang/yanju";
...
export const gettingStartedUrl = `${docsUrl}getting-started/`;
export const languageDocsUrl = `${docsUrl}language/`;
export const toolingDocsUrl = `${docsUrl}tooling/`;
export const ecosystemDocsUrl = `${docsUrl}ecosystem/`;
